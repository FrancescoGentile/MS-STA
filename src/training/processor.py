...
class TrainingProcessor: 
    ...
    def __init__(self, 
        ...
        self._model: Model = self._get_model(skeleton, train_dataset.num_frames)
    ...
    def _get_model(self, skeleton: SkeletonGraph, num_frames: int) -> Model:
        model = self._config.model_config.to_model(
            skeleton, self._num_classes, num_frames)
